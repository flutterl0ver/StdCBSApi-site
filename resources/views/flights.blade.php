...
<form method="POST" action="/search">
    ...
    <div>
        <input type="text" name="token" id="searchToken" class="textinput"
...
@if (session('response'))
    <div class="getjson">
        <button type="button" class="getjson" onclick="OpenJson(GetSearchRequest(response))">Просмотр запроса и ответа</button>
    </div>
    @if(session('response')['respond']['token'] != '')
