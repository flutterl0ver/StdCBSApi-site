...
<body>
    ...
    <div style="padding: 15px">
        ...
        Для регистрации и посадки на рейс пассажирам необходимо иметь при себе оригинал документа, внесённого
        ...
        документами, подтверждающими расходы на приобретение авиабилета для предоставления по месту работы, являются
        ...
        заказу (условия применения тарифа, условия возврата, допустимый багаж и т.д.) можете получить по телефону<br>
        +7 777 1231231
    </div><hr>
